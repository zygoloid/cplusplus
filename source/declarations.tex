...
\nontermdef{extension-namespace-definition}\br
        \terminal{inline\opt} \terminal{namespace} attribute-specifier-seq\opt original-namespace-name \terminal{\{} namespace-body \terminal{\}}
\end{bnf}
...
in an \grammarterm{original-namespace-definition}
or \grammarterm{extension-namespace-definition}

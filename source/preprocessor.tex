...
\indeximpldef{whether an implementation has relaxed or strict pointer safety}%
...
\indeximpldef{number of threads in a program under a freestanding implementation}%

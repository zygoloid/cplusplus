...
type, the conversion copy-initializes~(\ref{dcl.init})
a temporary object of type \tcode{T} from
the glvalue and the result of the conversion is a prvalue for the
temporary object; the conversion is a temporary expression (Clause~\ref{expr}).
